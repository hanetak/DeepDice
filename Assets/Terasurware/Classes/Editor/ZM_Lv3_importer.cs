...
public class ZM_Lv3_importer : AssetPostprocessor
{
    private static readonly string filePath = "Assets/Exel/ZM_Lv3.xls";
    private static readonly string[] sheetNames = { "Lv3", };
        ...
        foreach (string asset in importedAssets)
        {
            ...
            using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
            {
                ...
                foreach (string sheetName in sheetNames)
                {
                    ...
                    var data = (Lv3)AssetDatabase.LoadAssetAtPath(exportPath, typeof(Lv3));
                    if (data == null)
                    {
                        data = ScriptableObject.CreateInstance<Lv3>();
